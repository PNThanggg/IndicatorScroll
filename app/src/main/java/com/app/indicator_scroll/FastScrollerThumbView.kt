 ...
 * A com.app.indicator_scroll.FastScrollerThumbView is not required for a fast scroller to work, but it provides an
...
class FastScrollerThumbView @JvmOverloads constructor(
    ...
    private var thumbColor: ColorStateList by onUpdate(::applyStyle)
    ...
    private var textColor: Int by onUpdate(::applyStyle)
    ...
    fun setupWithFastScroller(fastScrollerView: FastScrollerView) {
        check(!isSetup) { "Only set this view's com.app.indicator_scroll.FastScrollerView once!" }
