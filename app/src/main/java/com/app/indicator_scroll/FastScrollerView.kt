...
class FastScrollerView @JvmOverloads constructor(
     ...
     *                      See [com.app.indicator_scroll.FastScrollerView.showIndicator].
     * @param useDefaultScroller whether or not this com.app.indicator_scroll.FastScrollerView should automatically scroll
     *                           [recyclerView] when an indicator is pressed.
     *                           See [com.app.indicator_scroll.FastScrollerView.useDefaultScroller].
     */
    @JvmOverloads
